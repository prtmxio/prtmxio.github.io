...
The ViT (Vision Transformer, Dosovitskiy et al.) treats an image as a sequence of patches — exactly like a sentence is a sequence of words.
...
2. **Max 77 tokens** (hard limit — context window)
...
After training, the space has a beautiful property: **linearity of meaning**.
...
The killer application: CLIP can classify images it was never explicitly trained to classify.
